...
const VERSION = 2;
const DEMO_CODES = ["FR-DEMO-0001", "FR-DEMO-0002", "FR-DEMO-0003"];
function isPlainObject(v) {
    return typeof v === "object" && v !== null && !Array.isArray(v);
}
function isValidPlanJsonV2(planJson) {
    if (!isPlainObject(planJson))
        return false;
    const days = planJson.days;
    const modules = planJson.modules;
...
async function main() {
    ...
    if (modulesCount === 0) {
        console.warn("⚠️ WARNING: modulesCount is 0. Engine will drop rules as unknown modules.");
    }
}
function defaultSourcesJson() {
    return {
        ...
        disclaimer: "Educational information only. Not medical advice. If you have urgent symptoms, contact your clinician or seek emergency care.",
    };
}
/**
...
function getCanonicalPlanJsonV2() {
    return {
        ...
        schemaVersion: 2,
        disclaimer: "Educational information only. Not medical advice. This plan is for general recovery support and tracking. If symptoms are severe, worsening, or feel urgent, contact your clinician or seek emergency care.",
